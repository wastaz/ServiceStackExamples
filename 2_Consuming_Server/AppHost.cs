...
namespace _2_Consuming_Server {
    internal class AppHost : AppHostHttpListenerBase {
        public AppHost() : 
            base("HttpListener Self-Host", typeof(AnimalService).Assembly) { }
        ...
        public override void Configure(Container container) {
            ...
            container.Register<IUserAuthRepository>(
                new RavenDbUserAuthRepository(Container.Resolve<IDocumentStore>()));
            ...
            userAuthRepo.CreateUserAuth(
                new UserAuth {UserName = "test"}, 
                "test123");
        }
    }
}
